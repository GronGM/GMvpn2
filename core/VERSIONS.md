...
| tun2socks engine      | gVisor (shared with Xray) | TCP via `gvisor.dev/gvisor` netstack + `golang.org/x/net/proxy` SOCKS5. UDP stubbed (no UDP ASSOCIATE in stdlib SOCKS5). See ADR 0004 §3. |
